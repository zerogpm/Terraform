...
resource "azurerm_monitor_autoscale_setting" "web_vmss_autoscale" {
  ...
  notification {
    email {
      ...
      custom_emails                         = [var.web_monitor_autoscale_setting_email]
    }
  }
  ################################################################################
  ################################################################################
  ...
  profile {
    ...
    fixed_date {
      timezone = "Pacific Standard Time"
      start    = "2023-08-16T00:00:00Z" # CHANGE TO THE DATE YOU ARE TESTING
      end      = "2023-08-16T23:59:59Z" # CHANGE TO THE DATE YOU ARE TESTING
    }
    ###########  START: Percentage CPU Metric Rules  ###########    
    ## Scale-Out 
    rule {
